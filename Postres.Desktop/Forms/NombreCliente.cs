...
{
    public partial class NombreCliente : Form
    {
        private Contenedor _contenedor;
        private RepositorioDeMenu _repositorioDePostres;
        public NombreCliente(Contenedor contenedor, RepositorioDeMenu repositrio)
        {
            InitializeComponent();
