...
namespace Postres.Desktop.Forms
{
    public partial class DetallesPostre : Form
    {
        ...
        public DetallesPostre(Contenedor contenedor,RepositorioDeMenu repositorio, Postre postre)
        {
        ...
        {
            _contenedor.CargarFormulario(new AgregarMenu(_contenedor, _repositorioDePostres, _postre)); 
        }

        private void AtrasBtn_Click(object sender, EventArgs e)
        {
            _contenedor.CargarFormulario(new ListaClientes(_contenedor, _repositorioDePostres));
        }
